...
public class DateTime implements Serializable {
	...
	/**
	 * If the this object is one day after the target date, this method returns
	 * true
	 * 
	 * @param targetDate
	 * @return
	...
	public boolean isDayAfter(DateTime targetDate) {
		...
		if (this.getYear() == targetDate.getYear()) {
			...
			} else if (this.getMonth() == targetDate.getMonth() + 1) {
				if (this.getDay() == 1 && targetDate.getDay() == targetDate.getDaysPerMonth(targetDate.getMonth())) {
					return true;
				}
			}
		}
