...
public class Animation extends Control 
{
	...
	public Animation(final AbsDims dim, final CommandToken<?> token_, final String frameName, 
			final boolean loop_, final int frameRate_, final CompletionCallback callback_, final String fileExtension) 
	{
		super(dim, token_);
